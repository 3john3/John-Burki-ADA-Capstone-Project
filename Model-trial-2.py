...
modeltrain2 = Sequential()
modeltrain2.add(Conv2D(filters=32, kernel_size=3, input_shape=(100,100,3)))
modeltrain2.add(Activation('relu'))
modeltrain2.add(MaxPooling2D(pool_size=(2,2)))
modeltrain2.add(Conv2D(filters=64, kernel_size=3))
modeltrain2.add(Activation('relu'))
modeltrain2.add(MaxPooling2D(pool_size=(2,2)))
modeltrain2.add(Flatten())
modeltrain2.add(Dense(128))
modeltrain2.add(Activation('relu'))
modeltrain2.add(Dropout(0.5))
modeltrain2.add(Dense(119))
modeltrain2.add(Activation('softmax'))

# Summary of the model
modeltrain2.summary()

# Compile model using SGD as comparison standard
modeltrain2.compile(optimizer='SGD',
...
# Train model
model_trial_2_train = modeltrain2.fit(
        training_set, 
        epochs=25,
...
acc_train = model_trial_2_train.history['accuracy']
acc_val = model_trial_2_train.history['val_accuracy']
...
loss_train = model_trial_2_train.history['loss']
loss_val = model_trial_2_train.history['val_loss']
