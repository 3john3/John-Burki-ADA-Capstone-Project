...
# Create second sequential model with one more layer
modeltrain2d = Sequential()
modeltrain2d.add(Conv2D(filters=32, kernel_size=3, input_shape=(100,100,3)))
modeltrain2d.add(Activation('relu'))
modeltrain2d.add(MaxPooling2D(pool_size=(2,2)))
modeltrain2d.add(Conv2D(filters=32, kernel_size=3))
modeltrain2d.add(Activation('relu'))
modeltrain2d.add(MaxPooling2D(pool_size=(2,2)))
modeltrain2d.add(Conv2D(filters=32, kernel_size=3))
modeltrain2d.add(Activation('relu'))
modeltrain2d.add(MaxPooling2D(pool_size=(2,2)))
modeltrain2d.add(Flatten())
modeltrain2d.add(Dense(128))
modeltrain2d.add(Activation('relu'))
modeltrain2d.add(Dropout(0.5))
modeltrain2d.add(Dense(119))
modeltrain2d.add(Activation('softmax'))

# Summary of the model
modeltrain2d.summary()

# Compile model using SGD as comparison standard
modeltrain2d.compile(optimizer='SGD',
...
# Train model
model_trial_2d_train = modeltrain2d.fit(
        training_set, 
        epochs=25, 
...
acc_train = model_trial_2d_train.history['accuracy']
acc_val = model_trial_2d_train.history['val_accuracy']
...
loss_train = model_trial_2d_train.history['loss']
loss_val = model_trial_2d_train.history['val_loss']
