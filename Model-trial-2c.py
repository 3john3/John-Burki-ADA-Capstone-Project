...
modeltrain2c = Sequential()
modeltrain2c.add(Conv2D(filters=32, kernel_size=3, input_shape=(100,100,3)))
modeltrain2c.add(Activation('relu'))
modeltrain2c.add(MaxPooling2D(pool_size=(2,2)))
modeltrain2c.add(Conv2D(filters=64, kernel_size=3))
modeltrain2c.add(Activation('relu'))
modeltrain2c.add(MaxPooling2D(pool_size=(2,2)))
modeltrain2c.add(Flatten())
modeltrain2c.add(Dense(256))
modeltrain2c.add(Activation('relu'))
modeltrain2c.add(Dropout(0.5))
modeltrain2c.add(Dense(128))
modeltrain2c.add(Activation('relu'))
modeltrain2c.add(Dropout(0.5))
modeltrain2c.add(Dense(119))
modeltrain2c.add(Activation('softmax'))

# Summary of the model
modeltrain2c.summary()

# Compile model using SGD as comparison standard
modeltrain2c.compile(optimizer='SGD',
...
# Train model
model_trial_2c_train = modeltrain2c.fit(
        training_set, 
        epochs=25, 
...
acc_train = model_trial_2c_train.history['accuracy']
acc_val = model_trial_2c_train.history['val_accuracy']
...
loss_train = model_trial_2c_train.history['loss']
loss_val = model_trial_2c_train.history['val_loss']
